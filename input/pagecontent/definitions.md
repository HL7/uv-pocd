...
|Channel | Umbrella object in the object model that groups together physiological measurement data and data derived from these data. (IEEE 11073-10201 DIM)|
...
|MDC Nomenclature | A code system embodied in the IEEE 11073-10101 Medical Device Communications Nomenclature standard, created to comprehensively identify by numeric codes measurements, devices, device components, and other objects in device models, and other data items related to medical device technology.|
|Rosetta Terminology Mapping (RTM) | A superset of the IEEE Medical Device Communications Nomenclature which the IHE RTM Committee uses as a record of the IEEE 11073-10101 MDC Nomenclature and a testing ground for emerging terminologies such as ventilation, infusion pumps and events from all classes of medical devices intended to be used in IHE Connectathons and balloted in the IEEE 11073 Point-of-Care WG.|
